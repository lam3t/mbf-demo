...
- **Backend:** Node.js + Express (hoặc NestJS nếu muốn cấu trúc module rõ ràng), TypeScript, JWT auth đơn giản, SQLite (better-sqlite3 / node:sqlite), Multer cho upload ảnh bằng chứng.
...
| FR-C.5 | Gắn thẻ lĩnh vực | Multi-select tag: Thuế, Đất đai, Môi trường, Trật tự đô thị | Dùng danh mục FR-0.9 |
...
RecommendationTagCatalog(id, code, name) // Thuế, Đất đai, Môi trường, Trật tự đô thị
